...
<body>
    ...
    <div class="page-content-wrapper">
        <form action="update-profiltoko.php" method="post">
            <div class="container">
                <!-- Profile Wrapper-->
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                    <div class="col-12 col-md-6">
                                        <input type="text" id="oldUsername" value="<?= $data['username'] ?>" hidden>
                                        <div class="title mb-2"><i class="lni lni-user"></i><span>Username <span class="text-danger">*</span></span></div>
                                        <input class="form-control" type="text" name="username" id="inputUsername" value="<?= $data['username'] ?>" required>
                                        <span id="error"></span>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="title mb-2"><i class="lni lni-envelope"></i><span>Email <span class="text-danger">*</span></span></div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <input class="form-control" type="text" name="nama_toko" value="<?= $data['nama_toko'] ?>" required>
                                    </div>
                                    <div class="col-12 col-md-6">
                                    ...
                                    <button class="btn btn-success w-100" type="submit" name="update-profiltoko" id="complete">Simpan</button>
