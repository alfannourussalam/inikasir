...
<body>
    ...
    <div class="page-content-wrapper">
        <form action="update-printer.php" method="post">
            <div class="container">
                <!-- Profile Wrapper-->
                        ...
                        <div class="card-body">
                            <form action="" method="">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="printer" value="<?php echo $printer['printer'] ?>" required>
                                </div>
                                <button class="btn btn-success w-100" type="submit" name="setup-printer">Simpan</button>
                            </form>
                        </div>
                    </div>
