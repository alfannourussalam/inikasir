    ...
    <div class="page-content-wrapper">
        ...
        <div class="top-products-area py-3">
            ...
            <div class="container">
                ...
                <form action="insert-satuan.php" method="post">
                    <div class="mb-3">
                        <button type="button" id="add-satuan" class="btn btn-primary">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table" width="100%" cellspacing="2">
                                    ...
                                    <tbody id="temp-satuan">
                                    </tbody>
                                </table>
                            </div>
                        </div>
                        <div class="row save mb-3 mx-3" style="display: none;">
                            <button type="submit" id="add-satuan" class="btn btn-success save" name="simpan">
        ...
        $(function() {
            ...
            $('#add-satuan').on('click', function() {
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" placeholder="masukkan nama satuan" name="nama[]" class="form-control" requried>
                    </td>
                    <td>
                        <button type="button" class="btn btn-danger remove">Hapus Record</button>
                    </td>
                </tr>
            `);
