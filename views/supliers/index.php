            ...
            <div class="container">
                ...
                <div class="card">
                    <div class="card-header py-3">
                        <div class="row">
                            <h6 class="col-md-6 m-0 mb-2 font-weight-bold text-primary"><i class="fas fa-shipping-fast"></i>Data Supliers</h6>
                            <div class="col-md-6 d-flex justify-content-end">
                                <span class="mx-2">
                                    <a href="tambah-suplier.php" class="btn btn-primary">Tambah Suplier</a>
                                </span>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped data" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php
                                    $data_suplier = suplier_all();
                                    $i = 1;
                                    foreach ($data_suplier as $v) { 
                                        $id =  base64_encode($v['id']);
                                        ?>
                                        <tr class="clickable-row" onclick="edit_suplier('<?php echo $id ?>')">
                                            <td><?php echo $i ?></td>
                                            <td><?php echo $v['nama_suplier'] ?></td>
                                            <!-- <td class="text-center">
                                                <a href="delete-suplier.php?dest=<?php // echo base64_encode($v['id']) ?>" class="btn btn-sm btn-danger" title="Hapus data" id="hapus-data">Hapus</a>
                                            </td> -->
                                        </tr>
                                    <?php
                                        $i++;
